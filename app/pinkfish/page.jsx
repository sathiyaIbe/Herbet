...
export default function pinkfish () {
const [hoverState,setHoverState]=useState(false)
let videoref =useRef(null)
function onchangeHover(){

    setHoverState(true)
    
}function onchangeHover1(){
    setHoverState(false)
  ...
  return (
    <div className='min-h-screen bg-[#F9F9F9]  overflow-hidden'>
        ...
        <div className='flex flex-col  mt-11 overflow-hidden'>
            ...
            <div className='flex'>
                {/* <>
                <div onMouseOver={onchangeHover} onMouseOut={onchangeHover1}  className='pf_gif_pla w-1/2'>  
                {hoverState?
                  <video 
                  autoPlay
                  loop
                  ...
                  src="/pf/pf_tab_gif.mp4"  />
     :            <img src='/pf/half_pf_1.png' className='' alt='show case'/>

            }          
           
            </div>
            </> */}
            <div className='pf_gif_play_1 w-1/2'></div>
            <img src='/pf/half_pf_2.png' className='w-1/2 object-cover' alt='show case'/>

            </div>
            <div className='flex '>
                <div className='pf_gif_play_2 w-1/3'>
