    ...
    <div className='min-h-screen bg-[#F9F9F9]  overflow-hidden'>
        ...
        <div className='flex flex-col w-[90%]'>
            <div className='flex flex-col self-center w-[90%] gap-4'>
                <h1 className='work_header'>Huawei</h1>
...
in Social Media</h1>
        ...
        <div className='flex '>
            <img src='/haw/haw_gallery_1.png' className='w-3/5' alt='show case'/>
            <img src='/haw/haw_gallery_2.png' className='w-2/5' alt='show case'/>
