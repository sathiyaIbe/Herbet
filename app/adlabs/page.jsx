...
export default function adlabs () {
        ...
        <div className='flex flex-col  mt-11 overflow-hidden'>
            ...
            <div className='flex gap-1 '>
                 ...
                 <div className=' bg-[#0618DE] flex flex-col w-full '>
                    ...
                    <img src='/al/al_demo_pic_3.png' className='' alt='show case'/>
                    <img src='/al/al_demo_pic_4.png' className='' alt='show case'/>
                    <img src='/al/al_demo_pic_5.png' className='' alt='show case'/>
